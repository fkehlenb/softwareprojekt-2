...
package Datenmodel {
  ...
  Role <|-left- Logistiker
  Role "0..*"-left-"1..*" User: hat >
  Role <|-right- Admin
  Role <|-right- t
  Role <|-- transport

  Logistiker "1" -- Probe: verwaltet >
  Logistiker "1" -- "1..*" Träger: verwaltet >
  Probe o-- "0..*"quantE : hat >
  Probe o-- "0..*"qualE : hat >
  Trägerart"1" --o "1.." Träger: < ist
  Probe "0..*"--o "0..1" Träger: befindet sich in >

  Admin "1" -- "1..*" User: verwaltet >
