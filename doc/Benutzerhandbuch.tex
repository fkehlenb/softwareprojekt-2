...
Farbige Zustände ist eine Webanwendung für die Abläufe im Labor des SFB 1232. \\
In unserer Anwendung haben Benutzer entsprechend Ihrer Rollen eine Übersicht über die Arbeit, die für Sie im Labor anfallen. Die realen Vorgänge werden durch Aufträge, die aus Prozessschritten bestehen, modelliert. Diese können erstellt, instanziiert, und danach von Station zu Station weitergereicht werden. Die zugehörigen Proben werden ebenfalls mitsamt ihrer Eigenschaften im System gespeichert; zu diesen können nach der Durchführung der Schritte die Eigenschaften aktualisiert werden. \\
Durch die automatische Organisation der Abläufe kann durch dieses System der Alltag im Labor etwas übersichtlicher ablaufen. Dies erfordert allerdings auch die konsequente Pflege der Daten im System von allen Benutzern. \\
Durch die verlässliche Nutzung des Systems werden ebenfalls automatisch die Protokolle erstellt.  \\
...
Um das System zum Laufen zu bringen, verfolgen Sie bitte Schritt für Schritt diese Installationsanleitung.\\
...
\begin{itemize}
	...
	\item Eine Wildfly 17+ Installation
\end{itemize}
...
Das System wird standardmäßig mit Daten befüllt und es werden Nutzer von allen Rollen erstellt. Diese sollen vom Admin, login: admin passwort: admin verändert und verwaltet werden, die Testdaten können entfernt werden und dienen nur als Grundlage für weitere Anpassungsschritte.
...
In der Navigationsleiste am linken Rand sehen Sie alle Aktionen, die Ihnen zur Verfügung stehen, sortiert nach den Rollen, die Sie haben. Sie können durch Klicken auf die Titel der Seiten auf die unterschiedlichen Seiten gehen. Ebenfalls können Sie zum Homescreen zurück, und sich abmelden. \\
...
https://phantomjs.org
\end{verbatim}
und befolgen der Installationsanleitung. Wichtig ist, dass PhantomJS auf dem Pfad \textit{/usr/bin/phantomjs} gesetzt ist.
%%%%%%%%%%
\subsection{Benutzer}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=0.5\textwidth]{screenshots/admin/nutzerloeschen.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=0.5\textwidth]{screenshots/admin/stationpsp.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=0.5\textwidth]{screenshots/admin/stationstandortliste.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=0.5\textwidth]{screenshots/admin/stationuser.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=0.5\textwidth]{screenshots/admin/standortformular.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/prozessschrittform.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/prozessschrittubersicht.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/prozessschritteingabe.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/prozessschrittlog.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/prozessschrittedit.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=0.5\textwidth]{screenshots/pk/prozesskettenvorlagejson.png}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/qualierstellen.png}
  \caption{Qualitative Eigenschaft erstellen}
  \label{fig:boat2}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/qualitabelle7.png}
  \caption{Qualitative Eigenschaften Übersicht}
  \label{fig:boat2}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/qualiedit.png}
  \caption{Qualitative Eigenschaften Bearbeiten}
  \label{fig:boat2}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/quantierstellen.png}
  \caption{Quantitative Eigenschaft erstellen}
  \label{fig:boat2}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/quantitabelle.png}
  \caption{Quantitative Eigenschaften Übersicht}
  \label{fig:boat2}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/quantiedit.png}
  \caption{Quantitative Eigenschaft bearbeiten}
  \label{fig:boat2}
\end{center}
\end{figure}
%%%%%%%%%%
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{screenshots/pk/json.png}
  \caption{JSON Exporte}
  \label{fig:boat2}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=0.7\textwidth]{screenshots/l/probeadd.png}
...
\endhead
Auftrag instanziieren & 36\\ \hline
Auftrag abbrechen & 36\\ \hline
Auftrag bearbeiten & 36\\ \hline
Auftrag starten  & 45\\ \hline
Auftrag Proben zuordnen & 45\\ \hline
Auftragsübersicht Logistiker & 45 \\ \hline
Auftragsübersicht Transporter & 57 \\ \hline
Auftragsübersicht Technologe & 50 und 53\\ \hline
Arbeitsauslastung  & 40\\ \hline
Benutzer bearbeiten & 15\\ \hline
Benutzer erstellen & 15\\ \hline
Benutzer löschen & 15\\ \hline
Erstinstallation & 15\\ \hline
Experimentierstation als kaputt melden & 49\\ \hline
Experimentierstation erstellen & 18\\ \hline
Experimentierstation löschen &18 \\ \hline
Experimentierstation bearbeiten & 18\\ \hline
Globale Einstellungen & 21\\ \hline
Lagerübersicht & 46\\ \hline
Probe als verloren melden & 46, 53, 58\\ \hline
Probenparameter hochladen  & 50\\ \hline
Proben erstellen  & 46\\ \hline
Prozesskettenvorlage erstellen & 34\\ \hline
Prozesskettenvorlagen bearbeiten &34 \\ \hline
Prozesskettenvorlagen löschen &34 \\ \hline
Prozessschritt Übersicht &26 \\ \hline
Prozessschritte als JSON exportieren  &40 \\ \hline
Aufträge als JSON exportieren & 40\\ \hline
Prozessschritt-Vorlage erstellen &28 \\ \hline
Prozessschritt-Vorlage löschen &28 \\ \hline
Prozessschritt-Vorlage bearbeiten &28 \\ \hline
Prozessschritt-Parameter erstellen & 32\\ \hline
Prozessschritt-Parameter löschen & 32\\ \hline
Prozessschritt-Parameter bearbeiten& 32\\ \hline
Prozessschritt-Parameter als JSON exportieren & 40\\ \hline
Prozessschritt-Zustandsautomat erstellen & 30\\ \hline
Prozessschritt-Zustandsautomat löschen &30 \\ \hline
Prozessschritt-Zustandsautomat bearbeiten & 30\\ \hline
Qualitative Eigenschaft erstellen & 38\\ \hline
Qualitative Eigenschaft löschen & 38\\ \hline
Qualitative Eigenschaft bearbeiten & 38\\ \hline
Quantitative Eigenschaft erstellen &38 \\ \hline
Quantitative Eigenschaft löschen &38\\ \hline
Quantitative Eigenschaft bearbeiten & 38\\ \hline
Standort erstellen & 20\\ \hline
Systembackup & 21\\ \hline
Träger erstellen & 44\\ \hline
Träger löschen  &44 \\ \hline
Träger bearbeiten & 55\\ \hline
Transportauftrag annehmen  & 57\\ \hline
Wenn unerreichbare Seiten aufgerufen werden & 61\\ \hline
Fehler im Suchfeld des Browsers & 61\\ \hline
\end{longtable}
