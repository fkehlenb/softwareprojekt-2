...
\begin{table}[]
    ...
    \hline
          ...
          Das Software kann neue Prozessketten und Prozessschrittparameter aus JSON-Dateien hochladen, und bestehende als JSON-Dateien exportieren.
          \\ \hline
...
\begin{table}[]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 1:} User Rollen \\ \hline
          Unterschiedliche Users können unterschiedliche Daten des Software sehen, jede User hat unterschiedlichen Möglichkeiten mit der Datum zu bearbeiten. \\ \hline
          \textbf{Einflussfaktoren: } \\
          T 1.5: Persistent \\
...
\begin{table}[]
    ...
    \hline
          ...
          Jeder User darf nur die Informationen sehen, die ihm nach seiner Rolle/seinen Rollen zustehen. Unauthorisierten Personen sollen keine Informationen angezeigt werden sollen. Auch die Bearbeitung von Informationen ist nur Rollen mit den entsprechenden Privilegien erlaubt. \\ \hline
          \textbf{Einflussfaktoren: } \\
          T 1.5: Persistent \\
          T 1.7: Multiple Users\\
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Macht eine Authentifizierung System, damit jeder User Zugriff auf Ihre und nur auf Ihre eigenen Daten haben.\\
          \\ \hline
    \end{tabular}
...
\begin{table}[]
    ...
    \hline
          ...
          Die Anwendung kann von mehreren Usern gleichzeitig benutzt werden. Dabei müssen die Daten in der Datenbank richtig angezeigt/verändert werden, und die Datensicherheit darf nicht komprimiert werden.
          \\ \hline
          \textbf{Einflussfaktoren: } \\
          T 1.5: Persistent \\
          T 1.7: Multiple Users\\
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Sicher Transaktionen auf der Daten Bank\\
          \\ \hline
    \end{tabular}
...
\begin{table}[]
    ...
    \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Der Admin des Software kann neues Mitglieder hinzufüngen und auch existierende Mitglieder entfernen
          \\ \hline
    \end{tabular}
...
\begin{table}[]
    ...
    \hline
          ...
          \\ \hline
          Proben können im Laufe der Bearbeitung einer Prozesskette kaputt oder verloren gehen. Diese können dann nicht weiter benutzt werden, was zu Problemen im weiteren Verlauf führen könnte. Deswegen muss im System anderen Usern klar gemacht werden sollen, dass Proben nicht mehr zur Verfügung stehen.
          \\ \hline
          \textbf{Einflussfaktoren: } \\
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Proben können als kaputt gemeldet werden können.
          \\ \hline
    \end{tabular}
    \caption{Caption}
    \label{tab:my_label}
...
\begin{table}[]
    ...
    \hline
          ...
          \\ \hline
          Die Vorgaben, welche Technologien bei der Implementierung verwendet werden sollen/dürfen, sind relativ streng. Das bedeutet, dass manche Entwickler eventuell noch nicht mit diesen Technologien vertraut sind, und sich erst einarbeiten müssen.
          \\ \hline
          \textbf{Einflussfaktoren: } \\
