...
Diese Architektur Beschreibung wurde im Rahmen von Software Projekt 2 im Wintersemester 2019/2020 geschrieben.  Das Projekt wurde im Rahmen des SFB 1232 Farbige Zustände erstellt. Die SFB-intitative "Farbige Zustände" erarbeitet sich eine neuartige experimentelle Methode der Werkstoffentwicklung.

Die Aufgabe unserer Software ist es einerseits der SFB-Initiative zu ermöglichen effizient und ohne Verzögerung durch einen Administrativen Mehraufwand für die untersuchten metallischen Konstruktionswerkstoffe Prozessketten zu finden. Andererseits ermöglichen wir es den Forschern der SFB-Initative einen Überblick über laufende Prozessketten und deren Prozessschritte zu behalten. Konkret bedeutet dies, dass wir es den Logistik-beauftragten ermöglichen mit unserer Software Proben und deren Träger zu verwalten. Den Technologen der SFB-Initiative ermöglichen wir einen Überblick über ihre Experimentierstationen zu behalten, dies bedeutet wiederum, das sie immer über die laufenden Prozessschritte informiert sind.
Der Prozesskettenadministrator kann Prozessketten erstellen und starten, diese Prozessketten können Vor- und Nachbedingungen haben. Sobald eine Prozesskette gestartet wurde kann sich ein Technologe diese als Auftrag annehmen. Wenn der Technologe wiederum Sachen von einem Ort zu einem anderen transportieren möchte, gibt er dem Transporter über das System Bescheid, damit dieser diesen Auftrag bei sich im System annehmen kann, und ihn anschließend ausführen kann. Sollte der Transporter auf seinem Weg Proben verlieren, so gibt er diese im System ein.
Sollte die Prozesskette gerade erst gestartet worden sein, so wird dem Logistiker Bescheid gegeben. Dieser überprüft wiederum, ob die Proben mit den gefragten Eingenschaften sich im Lager befindet. Sollte dieses nicht der Fall sein, so gibt er dem System Bescheid, und die Prozesskette wird abgebrochen. Außerdem ist er am Ende der Prozesskette dafür zuständig die Proben im Lager zu lagern.    

Das System enthält also \underline{5 Arten von Benutzern:}
\begin{itemize}
  \item System Administrator: Verwaltet die Nutzer des Systems.
  \item Prozessketten Administrator: Ist für die Erstellung und Verwaltung von Prozessketten zuständig.
  \item Logistiker: Ist für das Lager zuständig.
  \item Transporter: Transportiert Proben von A nach B.
  \item Technologe: Ist für die Ausführung von Experimenten zuständig. Außerdem wertet er die Ergebnisse der Experimente aus und protokolliert diese. Kann mehreren Experimentierstationen zugewiesen sein. 
\end{itemize}
...
Leser dieser Architekturbeschreibung sind somit nicht nur die Mitarbeiter des SFBs, sondern auch der Endkunde. Um also dem Leser ein klares Verständnis zur Funktionalität der Software zu geben, werden wir im folgenden erst einmal den Zweck ser Architekturbeschreibung erläutern, und dann Ausdrücke erklären welche für einen regulären Leser undeutlich sein können.

%TODO%
\subsection{Zweck}

  {\em Diese Architektur Beschreibung hat als Zweck die Ermittlung der Eigenschaften und Struktur der Software von Produktion und Logistik. Welche eine Verwaltung der Kette von Prozessen bearbeiten soll. damit die Benutzer oder Kunden als Basis für die Testen nutzen kann.
...
>>>>>>> a09986be888184c6d596c54865074afe0c373555
