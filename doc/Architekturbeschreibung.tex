...
\subsection{Zweck}
  ...
  {\em Diese Architekturbeschreibung beschreibt die Architektur von +++BLABLA+++, eine digitale Software welche die Erstellung, Verwaltung und Durchführung von Prozessketten ermöglicht, mit wessen Hilfe neue Werkstoffeigenschaften gefunden werden sollen für den industriellen Gebrauch. Es beschreibt wie das System von +++BLABLA+++ implementiert werden soll, und wie seine Struktur aussehen wird. 
Dieses Dokument soll allen die die Software bedienen und bearbeiten werden dabei helfen die Struktur und Funktionsweise von +++BLABLA+++ zu verstehen. Es soll sowohl den Entwicklern eine Übersicht über die Funktionsweise der Software geben, welche diese schließlich implementieren werden, als auch den Testern zur Vorbereitung  ihrer Tests. Es soll außerdem dem Systemadministratoren eine Übersicht der Software geben, da diese das System anschließend verwalten müssen, und diese vielleicht die Software weiterentwickeln möchten. 
}
