...
\end{center}
\end{figure}
Dieses Modul ist für die Erstellung und Verwaltung von Nutzern zuständig. Durch User Controller können z.B. neue Nutzer erstellt werden, oder die Daten von bestehenden Users verändert werden. Dafür greift Controller auf die Datenklasse User zu um diese Nutzer zu erstellen und verwalten. Um diese anschließend in der Datenbank abspeichern zu können, greift User Controller auf die UserDAO zu um die Benutzer in der Datenbank zu Speichern und Verwalten. In der Datenklasse von User wird zudem auch die eingestellte Sprache des Nutzern eingespeichert und nach Wunsch geändert.
...
Um nun Aufträge erstellen oder verwalten zu können, muss unser Auftragscontroller zugriff auf die Auftrags Datenklasse haben. Zusätzlich möchte man diese in der Datenbank einspeichern und verwalten können, wozu der Controller auch Zugriff auf die DAO Klasse von Auftrag hat.
\newpage
...
\end{center}
\end{figure}
Nun möchte man ja vielleicht Prozessschritte erstellen. Ein Prozessschritt benötigt einen Prozessschrittszustandsautomat und einen Prozessschrittlog. Um nun Prozessschritte erstellen zu können muss unser Prozessschrittcontroller zugriff auf die Prozessschritt Datenklasse haben, und um diese anschließend in der Datenbank verwalten zu können brauch er auch zugriff auf ProzessschrittDAO.
\newpage 
