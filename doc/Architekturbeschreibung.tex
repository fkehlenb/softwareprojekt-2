...
\subsubsection{Experimentier Station Modul}
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=\textwidth]{UML/Modules/ExperimentierStation.pdf}
  \caption{Experimentier Station Module}
  \label{fig:boat1}
\end{center}
\end{figure}
\newpage

\subsubsection{Prozess Schritt Zustands Automat Vorlage Modul}
\begin{figure}[h!]
\begin{center}
...
\subsubsection{Prozess Schritt Zustands Automat Modul}
\begin{figure}[h!]
\begin{center}
...
\subsubsection{Prozess Schritt Log Modul}
\begin{figure}[h!]
\begin{center}
