...
String Zustand gespeichert. Ein Prozessschritt gehört zu einem Auftrag, ein Auftrag
...
Um den Up/Download von den Parameter der Prozesschritte als JSON zu ermöglichen verwenden wir JSON-B. Hiermit setzen wir die Strategie 4.1 \ref{strategie:4.1}  um. Dafür stellen wir ein Interface
