    ...
    \hline
         ...
         \hline
          ...
          \textbf{Strategie 2.1: JavaEE Security(ausgewählt)} Das system wird das Java Class PasswordAuthentication nutzen, durch wen die User sich anmelden können. \\
           \textbf{Strategie 2.2: Eigene Implementierung:} Wir werden eine eigene Klasse implementieren, um die User an der Software sich anmelden kann. \\
          \\ \hline
...
\begin{table}[H]
    ...
    \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 3.1:} Jede User  wird ein Variabel Aktiv haben, an der Fall dass ein User nicht mehr an der Firma arbeitet wird. Diese Instanz wird deaktiviert werden. aber an der Data Base wird die Daten noch existieren, damit ein weiteres Kontrolle  auf die Aufgabe der deaktivieren User zu haben. 
          \textbf{Strategie 3.2:} \\
          \\ \hline
...
\begin{table}[]
    ...
    \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 6.1:} Eingeschaften der Stationen herausfinden, damit der entsprechende Nutzer eine Station einfach hinzufügen kann. Nutzung von Spike Data modulo, um query auf der Database zu erstellen.
          \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \hline
	 ...
	 P1.10.3: Proben-id-Nummern \\
          \hline
          \textbf{Strategien} \\ \hline
\textbf{Strategie 8.1:In kleinen Schritten:(ausgewählt)} Es wird immer nur ein kleiner Ausschnitt aus der Datenbank geladen. Dafür wird lazy loading gennutzt \\
         \textbf{Strategie 8.2:} Es werden Repräsentanten von Probenkügelchenmenge ausgewählt und angezeigt, dazu noch eine Gesamtanzahl der gleichartigen Kügelchen. \\
          \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 13.1: Aneignen Technologien:} Alle Entwickler müssen sich die Zeit nehmen, sich in diese Technologien anzueignen. Ebenfalls sollte die Gruppe sich untereinander unterstützen; hilfreich wäre zum Beispiel eine Sammlung an Problemen, auf die Entwickler gestoßen sind, und wie sie diese gelöst haben, um eventuell anderen Gruppenmitgliedern die Recherche zu erleichtern.
          \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 14:} Verlust/Schaden an Proben !Teil der Mindestanforderungen
          \\ \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 14.1: Probenmeldung: (ausgewählt)} Proben können als kaputt gemeldet werden. Dadurch werden sie sowohl als solche dargestellt, und können weder manuell noch automatisch irgendwelchen Prozessen zugeordnet werden. \\
          \textbf{Strategie 14.2: Ignorieren:} Für einzelne Proben werden solche Ereignisse ignoriert, mit der Hoffnung, dass es nicht häufig vorkommt. Zur Not soll ein Prozess gestoppt werden können, damit einem neuen Prozess neue Proben zugeordnet werden können. \\
          \\ \hline
    \end{tabular}
    \caption{Verlust/Schaden an Proben Problemkarte}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 15:} Nebenläufige Benutzung  \\ \hline !H2 TEIL DER MINDESTANFORDERUNGEN!
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 15.1: Einsatz ein Transaktionssicherheit  Datenbank:} Nutzung eine Datenbank, die Transaktion Sicherheit . Infolgedessen kann man inkonsistente  Transaktionen vermeiden, wenn multiple User an der Software gleichzeitig arbeiten. \\
          \textbf{Strategie 15.2: Warnungen zur Users:} Informieren zu der User, dass andere Users  arbeiten an der selbe Datei, damit der User  Nebenläufigkeit Probleme vermeiden kann. \\
          \\ \hline
    \end{tabular}

    \caption{Nebenläufige Benutzung Problemkarte}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 16:} Prozessbearbeitung und Überwachung %Strategien?
          \\ \hline
