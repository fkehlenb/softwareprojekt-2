...
\begin{table}[H]
    ...
    \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          %\textbf{Strategie 1:} Das system wird das Java Class PasswordAuthentication nutzen, durch wen die User sich anmelden können. diese classe  \\
...
% Unnötig, weil schon Teil der Mindestanforderungen
%\begin{table}[]
%    \centering
%    \begin{tabular}{|p{15cm}|}
%    \hline
...
%    \label{tab:my_label}
%\end{table}
%Hier haben wir uns für die erste Strategie entschieden, weil es eine benutzerfreundlichere Lösung ist. 
...
\begin{table}[H]
    ...
    \hline
          ...
          \\ \hline
          Der Administrator soll neue Stationen hinzufügen können.  Die Software muss die Fähigkeit haben neue Stationen zu übernehmen und zu nutzen.
          \\ \hline
          \textbf{Einflussfaktoren: } \\
          T 1.5: Persistenz \\
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Administrator kann Instanzen von Stationen erzeugen.
...
\begin{table}[H]
    ...
    \hline
          ...
          P 1.7.2: Automatisches Zuordnen\\
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Zustandsau
          \\ \hline
    \end{tabular}
    \caption{Caption}
    \label{tab:my_label}
...
\begin{table}[H]
    ...
    \hline
<<<<<<< HEAD
          \textbf{Problem 9:} Laden Informationen
=======
          \textbf{Problem 10:} Laden von Informationen
>>>>>>> 2c6ea46263ebec90b8b45d523430cde90a3b968c
          \\ \hline
...
\begin{table}[]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 10:} Verlust/Schaden an Proben
          \\ \hline
...
%    \begin{tabular}{|p{15cm}|}
%    \hline
%          \textbf{Problem 11:} Verlust/Schaden an Proben %Problem: auch in den Mindestanforderungen
%          \\ \hline
%          Proben können im Laufe der Bearbeitung einer Prozesskette kaputt oder verloren gehen. Diese können dann nicht weiter benutzt werden, was zu Problemen im weiteren Verlauf führen könnte.
%          \\ \hline
%          \textbf{Einflussfaktoren: } \\
...
\begin{table}[]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 12:} Vorgaben von Technologien
          \\ \hline
...
%          T1.5: Persistenz \\
 ...
 %         \hline
 %         \textbf{Strategien} \\ \hline
 %         \textbf{Strategie 1:} Alle Entwickler müssen sich die Zeit nehmen, sich in diese Technologien anzueignen. Ebenfalls sollte die Gruppe sich untereinander u%nterstützen; hilfreich wäre zum Beispiel eine Sammlung an Problemen, auf die Entwickler gestoßen sind, und wie sie diese gelöst haben, um eventuell anderen G%ruppenmitgliedern die Recherche zu erleichtern.
%          \\ \hline
%    \end{tabular}
%    \caption{Caption}
%    \label{tab:my_label}
