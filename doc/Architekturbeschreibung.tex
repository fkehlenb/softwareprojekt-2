...
\textbf{Strategie 1:} Jeder Mitarbeiter kriegt für jede der Rollen, die er erfüllt, einen eigenen Account. \\
          \textbf{Strategie 2: Rollen als Enum: (augewählt)} Die Rollen werden als Aufzählungstyp realisiert, der in einer m:m Beziehung zu der Userklasse steht. Dadurch kann für jeden User gespeichert werden, welche Rollen er/sie innehat. Die Sicherheit bezüglich der unterschiedlichen Fähigkeiten/Rechte der Rollen wird über die JavaEE-Security-Spezifikation realisiert (siehe Strategie 1 für Problem 2)\\
         % \textbf{Strategie 1:} \\
    %    Implementieren an der Klasse User ein Liste mit der Daten Typ Enum, diese Liste die Rollen der jede User halten wird und durch diese List wird abgeleitet unterschiedlichen Teilen an der Interface, infolge von welche Rollen der User hat.\\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
         % \textbf{Strategie 1:} Das system wird das Java Class PasswordAuthentication nutzen, durch wen die User sich anmelden können. \\
           \textbf{Strategie 1:JavaEE: (augewählt)} Da JavaEE eine Vorgabe ist, nutzen wir die davon zur Datensicherheit zur Verfügung gestellte Spezifikation JavaEE security.\\
...
\begin{table}[H]
    ...
    \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Nutzung der Java API und JSON Datei zu bearbeiten, weil diese API eine weise in JSON bearbeiten, generieren und Query anbietet .
          \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Administrator kann Instanzen von Stationen erzeugen und an der Datenbank zu erzeugen.
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 7:} Überwachung der Zustände
          \\ \hline
          Wenn ein Logistiker einen Prozess gestartet hat, sollte der Prozess gestoppt werden können, woraufhin die Proben sofort in das Lager gebracht werden und keine weiteren Schritte durchgeführt werden dürfen. Dementsprechend muss vom Prozesskettenadministrator in die laufende Kette eingegriffen werden dürfen.
          \\ \hline
          \textbf{Einflussfaktoren: } \\
          T 1.5: Persistenz \\
          P 1.7: Aufträge\\
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Prozess muss eine Variablen von zustand zu haben, welche der Logistiker und Prozesskette-admin verändere kann. Jede Prozesskette hat eine klasse für die Prozessauftrag, welche der Logistiker bestätigen wird, um die Prozess zu starten.
          \\ \hline
    \end{tabular}
    \caption{Caption}
    \label{tab:my_label}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 8:} Prozessbearbeitung und Überwachung
          \\ \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Prozesskette bestehe aus Prozessschritte. Diese Prozessschritten können in eine beliebige Reihen folge gestellt zu werden.
          \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 9:} Laden von Informationen
          \\ \hline
	 ...
	 P1.10.3: Proben-id-Nummern \\
          \hline
          \textbf{Strategien} \\ \hline
\textbf{Strategie 1:In kleinen Schritten:(ausgewählt)} Es wird immer nur ein kleiner Ausschnitt aus der Datenbank geladen. \\
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 10:} Verlust/Schaden an Proben %IN DEN MINDESTANFORDERUNGEN!!
          \\ \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Proben können als kaputt gemeldet werden, dass ich durch ein Variabel die jede Probe Inhalt. jede Transporter kann diese Variablen verändert.
          \\ \hline
    \end{tabular}
    \caption{Caption}
    \label{tab:my_label}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 11:} Ambitionierter Zeitplan
          \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 12:} Vorgaben von Technologien %KEIN EINFLUSS AUF DIE ARCHITEKTUR!!
          \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 13:} Probenzuordnung zu Träger
          \\ \hline
          Jede Probe braucht ein Container, womit unterschiedliche Proben gleichzeitig transportieren werden können.
          \\ \hline
          \textbf{Einflussfaktoren: } \\
          P1.7.2: Automatisches Zuordnen \\ %das hat nichts mit diesem Problem zu tun
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:}  eine Klasse zu erzeugen, die aus Probe bestehe. diese klasse Träger gehört zu eine Station und können auch gelagert werden. durch diese klasse die Logistiker können.
          \\ \hline
    \end{tabular}
    \caption{Caption}
    \label{tab:my_label}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 14:} Kompetenz der Entwickler
          \\ \hline
