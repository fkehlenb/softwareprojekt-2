...
\begin{table}[]
    ...
    \hline
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} Logistiker hat ein Direkt zugriff auf der Datenbank, um zu sehen. Wie viele Proben die Datenbank hat.
          \\ \hline
    \end{tabular}
    \caption{Caption}
    \label{tab:my_label}
...
\begin{table}[]
    ...
    \hline
          ...
          \\ \hline
          Jede Probe braucht ein Container, womit unterschiedliche Proben gleichzeitig transportieren sein können.
          \\ \hline
          \textbf{Einflussfaktoren: } \\
