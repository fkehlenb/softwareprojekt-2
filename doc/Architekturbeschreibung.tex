...
\begin{tabular}[c]{@{}l@{}}Abge-\\ leitet\\aus\end{tabular} & Einflussfaktor                                                                        & \begin{tabular}[c]{@{}l@{}}Flexibilität und \\ Veränderlichkeit\end{tabular}                                                              & \begin{tabular}[c]{@{}l@{}}++/\\\\ −−\end{tabular} & Auswirkungen                                                                                                                                                                                                                              \\ \hline
 \multicolumn{5}{|l|}{P1.5: Prozessschritte}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
                                                          & \begin{tabular}[c]{@{}l@{}}Prozessschritte\\ sollen erstellt,\\ gelöscht, \\bearbeitet, und\\ hervorgehoben\\(sofern im \\Zustand kaputt)\\ werden können. \end{tabular}      & \begin{tabular}[c]{@{}l@{}}Keine\\ Veränderlichkeit,\\ da Teil der\\ Mindestanforderungen.\end{tabular} & \begin{tabular}[c]{@{}l@{}}−−/\\   −−\end{tabular} & \begin{tabular}[c]{@{}l@{}}Mangel an den\\ Mindestanforderungen,\\ Architektur wird\\ möglicherweise vom \\Kunden nicht akzeptiert.\end{tabular} \\ \hline
 \multicolumn{5}{|l|}{P1.5.1: Prozessschritte an Experimentierstationen}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
                                                          & \begin{tabular}[c]{@{}l@{}}Für jeden\\ Prozessschritt \\soll gespeichert \\werden, an \\welchen Stationen \\dieser durchgeführt\\ werden kann. \end{tabular}      & \begin{tabular}[c]{@{}l@{}}Keine\\ Veränderlichkeit,\\ da Teil der\\ Mindestanforderungen.\end{tabular} & \begin{tabular}[c]{@{}l@{}}−−/\\   −−\end{tabular} & \begin{tabular}[c]{@{}l@{}}Die Architektur muss \\diese Information speichern\\ und damit umgehen \\können, dass es\\ eventuell im Ablauf\\ einer Prozesskette \\mehrere Optionen gibt.\end{tabular} \\ \hline
...
\multicolumn{5}{|l|}{P1.6.1: Prozesskettenart}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
                                                          & \begin{tabular}[c]{@{}l@{}}Jede\\ Prozesskette\\ ist einem \\Typ zugeordnet. \end{tabular}      & \begin{tabular}[c]{@{}l@{}}Keine\\ Veränderlichkeit,\\ da Teil der\\ Mindestanforderungen.\end{tabular} & \begin{tabular}[c]{@{}l@{}}−−/\\   −−\end{tabular} & \begin{tabular}[c]{@{}l@{}}Die unterschiedlichen \\Arten müssen\\ irgendwie gespeichert\\ werden. \end{tabular} \\ \hline
\multicolumn{5}{|l|}{P1.6.2: Zustand Prozessketten}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
                                                          & \begin{tabular}[c]{@{}l@{}}Für jede \\Prozesskette\\ soll angegeben \\werden können,\\ welche Zustände\\ sie durchlaufen\\ kann. \end{tabular}      & \begin{tabular}[c]{@{}l@{}}Keine\\ Veränderlichkeit,\\ da Teil der\\ Mindestanforderungen.\end{tabular} & \begin{tabular}[c]{@{}l@{}}−−/\\   −−\end{tabular} & \begin{tabular}[c]{@{}l@{}}Die Architektur \\muss es möglich \\machen, dass in \\den Zuständen\\ navigiert wird (von\\ einem zum nächsten). \end{tabular} \\ \hline
...
\multicolumn{5}{|l|}{P1.7.3: Zustand Prozessschritt}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
...
\multicolumn{5}{|l|}{P1.8.1: Trägerarten}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
                                                          & \begin{tabular}[c]{@{}l@{}}Für jeden\\ Träger soll \\gespeichert\\ werden, von \\welcher Art\\ er ist. \end{tabular}      & \begin{tabular}[c]{@{}l@{}}Keine\\ Veränderlichkeit,\\ da Teil der\\ Mindestanforderungen.\end{tabular} & \begin{tabular}[c]{@{}l@{}}−−/\\   −−\end{tabular} & \begin{tabular}[c]{@{}l@{}}Träger müssen ein\\ Attribut Art haben. \\ \end{tabular} \\ \hline
...
\multicolumn{5}{|l|}{P1.10.2: Archivierte Proben}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \\ \hline
                                                          & \begin{tabular}[c]{@{}l@{}}Proben müssen\\ archiviert werden\\ können. \end{tabular}      & \begin{tabular}[c]{@{}l@{}}Keine\\ Veränderlichkeit,\\ da Teil der\\ Mindestanforderungen.\end{tabular} & \begin{tabular}[c]{@{}l@{}}−−/\\   −−\end{tabular} & \begin{tabular}[c]{@{}l@{}}Die Architektur muss \\vorsehen, dass\\ Proben archiviert werden, \\wobei die zustäzlichen \\notwendigen Informationen\\ gespeichert werden sollen \\und die Probe im\\ Lager landet, wo sie \\kein Teil von einer \\laufenden Prozesskette\\ ist. \end{tabular} \\ \hline %TEXT ÄNDERN UND ÜBERALL NUMMERN ÄNDERN
\multicolumn{5}{|l|}{P1.10.3: Lagerübersicht}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
...
\multicolumn{5}{|l|}{P1.10.4: Proben-id-Nummern}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
...
\multicolumn{5}{|l|}{P1.10.5:Proben Kommentar}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
...
\multicolumn{5}{|l|}{P3.1: User Rechte}                                                                         \\ \hline
 ...
 \multicolumn{5}{|l|}{P4.1: Datenbank}                                                                         \\ \hline
...
\begin{table}[H]
    ...
    \hline
          ...
          Der Prozesskettenadministrator möchte abstrakte Prozessketten und -schritte erstellen können, die als Vorlagen dienen. Die Prozesskettenvorlagen sollen aus Prozessschrittvorlagen bestehen, und instanziiert werden können. \\
          \\ \hline
          \textbf{Einflussfaktoren: } \\
          P1.6: Prozessketten \\ 
	P1.7: Aufträge \\
	P1.5: Prozessschritte \\
	P1.5.1: Prozessschritte an Experimentierstationen \\
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 3.1: Eigene Klassen: (ausgewählt)}  Es gibt getrennte Klassen für die Vorlagen und die tatsächlichen Instanzen. \\
          \\ \hline
    \end{tabular}
    \caption{}
...
\end{table}
Hier haben wir uns für die erste Strategie entschieden, weil es die einzige Möglichkeit ist, die wir gefunden haben, mit der wir die unterschiedlichen Assoziationen, die die Vorlagen und Instanzen haben, sowie die dazukommenden Parameter der Instanzen von Schritten und Ketten darstellen können.  \\ %TODO
...
\end{table}
Hier haben wir uns für die erste Strategie entschieden, weil diese Umsetzung weniger aufwändig zu sein scheint. \\
...
Die Nutzer können mit den Daten des Systems interagieren (durch unterschiedliches, vorausgesetzes Verhalten). Die Daten sollen sichtbar, speicherbar und bearbeitbar sein. Daher braucht das System eine geordnete Weise jede verlangte Funktionalität zu implementieren.
          ...
          \hline
          \textbf{Strategien} \\ \hline
            \textbf{Strategie 15.1: Kapselung des Datenhaltung:(ausgewählt)} Wir nutzen unterschiedliche Komponente, die unterschiedliche abstrahierte Teile des Systems tragen können, um eine schnelle und sichere Implementierung  zu erreichen.
          \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \hline
          ...
          \textbf{Einflussfaktoren: } \\
         P1.6 Prozessketten \\ 
	P1.6.2: Zustand Prozesskette \\
          \hline
          \textbf{Strategien} \\ \hline
	\textbf{Strategie 18.1: als Enum: (ausgewählt)} Die Zustände werden als Enum gespeichert. \\
...
%Produktfunktionen und \linebreak-attributen. Sie l\ref{•}egt die Grobstruktur fest,
...
\textbf{BusinessLogik:} In diese Teil liegt die Funktionalität des System, diese Teil ist von Controller und die Bearbeitung ihre Data in die Persistenz Komponente benutzt. Hier sind das gewuchtetes Verhalten des System implementiert. diese Schnittstelle ergibt sich aus der  Strategie 15.1.  \\

\textbf{Model:} Hier liegen die Daten der User, Prozesskette , Proben sowie Daten und Vormerkungen des System. Diese Komponente ist mit der Controller und Persistenz verwundet, weil die Daten das Interfaces gezeigt werden, sind das an der Model implementieren. Diese Komponente ergibt sich aus der Strategie 15.1. \\

\textbf{Interface:} In diesem Teil liegt die User Interface, wo die User mit den System interagieren können. Diese Problem Karte beziehen sich aus Strategie 1.2, weil jede User hat ein unterschiedliche Oberfläche, mit wenn er mit des System interagieren kann. Außerdem ergibt sich aus die Strategie ~\ref{sec:strategie151}. Diese Komponente ist verwunden mit der BusinessLogik, um die Request und Data Bearbeitung zu erreichen.\\
...
\subsection{Automatische statistische Ausewertung} { Die erste Idee zum
  sinnvollen Erweitern der Software soll eine Vorraussicht ausgeben können, wie
  ...
  Eigenschaftenänderung zurück, die am wahrscheinlichsten ist. }
\subsection{Vorraussichtliche Dauer eines Prozesses} { Man kann den Algorithmus
  aus der Kristallkugel Software auch dafür verwenden, dass aus den durch den
  Algorithmus aus 9.1 errechneten empirischen Daten die voraussichtliche Dauer
  eines Prozesses errechnet und ausgegeben wird. Hier braucht man, wie in 9.1,
  eine neue Klasse, welche die Statistiksoftware beinhaltet, aus welcher man
  dann eine wahrescheinliche Zeit herausbekommt }
\subsection{Scanner}{
  ...
  die Buisnesslogik die Proben und Träger im Modell und  aktualisiert. Der
  Zustand der jeweiligen Prozesschritte muss ebenfalls verändert werden.		
}
