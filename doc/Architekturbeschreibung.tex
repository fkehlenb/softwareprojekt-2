    ...
    \hline
         ...
         \hline
          \textbf{Strategien} \\ \hline
            {\phantomsection}          
           \label{strategie:2.1}     
          \textbf{Strategie 2.1: JavaEE Security} Das system wird das Java Class PasswordAuthentication nutzen, durch wen die User sich anmelden können. \\ % das was liam meinte (steht in altem commit?
            {\phantomsection}          
           \label{strategie:2.2}     
           \textbf{Strategie 2.2: Eigene Implementierung:} Wir implementieren selber ein System zur Authentifizierung von Usern. \\
             {\phantomsection}          
           \label{strategie:2.3}     
           \textbf{Strategie 2.3: Apache Jiro (ausgewählt):} Nutzung von Apache Jiro um die view and Login des system.\\
          \\ \hline
