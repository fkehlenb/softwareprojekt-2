...
Um des Rahmen der Fach Software Projekt von der Universität Bremen zu erfühllen, entwickeln wir (Data Colorado) eine Web Aplikation, die Prosezz in eine Produktion  kette verwalten kann. Die Kunde dieses Software ist Farbige Zustände.

Das software muss bei der Verwaltung eine Prozess Kette helfen. man kann unterschiedliche Prozesse auf eine zustanden stellen. außerdem kann man durch diese Kette der Zuständ der Prube überwachen. in dem Prozess einer Pruebe reargieren Unterschiedlichen Nutzer zum Bespielt, Prozessketteadministrator, der das Prozesskette umbaut und Trasnpoter, der ein Probe durch unterschiedlichen Stationen trasporter kann.

Das Software muss unterschidliche Anforderung Erfullen, diese unterschiedliche Anfoprderung wurde von der Kunde erstellt, als Haupt funtionalitäten haben wir:
\begin{itemize}
  \item Admin kann Nutzer und Stationen einfüngen und entfernen.
  \item PK Administrator instanziert eine Prozess Kette.
