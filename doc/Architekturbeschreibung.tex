\documentclass[enabledeprecatedfontcommands,fontsize=12.1pt,paper=a4,twoside]{scrartcl}
...
ausgeführt.
Es ist dem pkAdmin möglich sich den den ProzessSchrittZustandsAutomaten des
ProzessSchrittes anzeigen zu lassen. Damit die ProzessSchrittVorlage sich
nachher Experimentierstationen sich zuweisen kann setzt der pkAdmin die Eingabe
und Ausgabe Träger für die ProzessSchrittVorlage. Nun kann der pkAdmin die
...
Als letzes setzt der pkAdmin die geschätzte Dauer für die Durchführung des
ProzessSchrittes. Jetzt verwaltet der ProzessKettenVorlageController wieder.
Falls der pkAdmin jetzt weitere ProzesskettenVorlagen bearbeiten möchte, kann er
dies nun tun.
...
dies nicht klappt, muss der pkAdmin die probleme in den ProzessSchrittVorlagen
...
Der pkAdmin kann die angeforderten Proben setzen. Sobald die Verifizierung der
...
Probenzuweisungsauftrag, falls die Anfrage genehmigt wurde, kann der PKAdmin nun
