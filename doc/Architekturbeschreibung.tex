...
\begin{table}[]
    ...
    \hline
          ...
          \textbf{Strategie 1:} Das system wird das Java Class PasswordAuthentication nutzen, durch wen die User sich anmelden können. \\
           \textbf{Strategie 2:} Wir werden eine selbe Klasse implementieren, um die User an der Software sich anmelden kann. \\
          \\ \hline
    \end{tabular}
...
>>>>>>> 667d6a57cde317e75a0d16754f7d6e27d9b27ac5
          \\ \hline
          \textbf{Einflussfaktoren: } \\
          T 1.5: Persistenz \\
...
\begin{table}[]
    ...
    \hline
          ...
          \\ \hline
<<<<<<< HEAD
          Wenn ein Logistiker einen Prozess gestartet hat, sollte der Prozess gestoppt, wieder gestartet und priorisiert.
=======
...
<<<<<<< HEAD
          ...
          \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 1:} die Klasse  Prozesskette bestehe aus Prozessschritte. Diese Prozessschritten können in eine beliebige Reihen folge gestellt zu werden.
=======
          T 1.5: Persistenz \\
          P 1.7: Aufträge \\
          \hline
