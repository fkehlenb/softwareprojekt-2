...
\begin{table}[H]
    ...
    \hline
         ...
         \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 2.1: Chiro(ausgewählt)} Wir benutzen Chiro \\
	\textbf{Strategie 2.2: JavaEE Security:} Wir benutzen JavaEE Security. \\
           \textbf{Strategie 2.3: Eigene Implementierung:} Wir implementieren selber ein System zur Authentifizierung von Usern. \\
          \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 3:} Entlassen Mitarbeiter \\ \hline  %Gruppe Modellierung fragen
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 4:} Upload/Download Prozessketten- und Prozessschrittparameter \\ \hline %Liam fragen
          ...
          \textbf{Strategie 4.2:} Dafür nutzen wir jakarta EE und die Rest Unterstüzung von Klassen welche Serialisierbar sind, werden durch Annotation so erweitert, dass eine JSON Repräsentation möglich ist. %what? und sind das wirklich zwei, oder machen wir beiden?
          \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 6:} Stationenbearbeitung %Liam fragen
          \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 7:} Priorisieren von Prozessketten %Gruppe Modellierung fragen
          \\ \hline
          Prozessketten sollen priorisiert werden können, was zur Folge hat, dass sie, wann immer mehrere Prozessketten auf die gleichen Aktionen warten, schneller drankommen. 
          \\ \hline
          \textbf{Einflussfaktoren: } \\
          T 1.5: Persistenz \\
          P 1.7: Aufträge \\
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{15cm}|}
    \hline
          \textbf{Problem 16: Vor- und Nachbedingungen Prozessschritte} 
          \\ \hline
          Beschreibung
          \\ \hline
          \textbf{Einflussfaktoren: } \\
	...
	Strategien
          \\ \hline
    \end{tabular}
    \caption{Vor- und Nachbedingungen Prozessschritte Problemkarte}
