...
Ein ProzessSchritt ist eine instanzierte ProzessSchrittVorlage. Ihre Attribute
sind eine Prozesschritt ID, ein Boolean uploaded, der auf True gesetzt wird,
...
Experimentierstation gibt, wo aktuell dieser Prozesschritt durchläuft, der String zustandsAutomat, der den aktuellen Zustand aus dem ProzessSchrittZustandsAutomaten speichert. Ein Prozessschritt gehört zu einem Auftrag, ein Auftrag
...
Als  App bezeichnen wir den Teil der Webapplikation, der
