...
Einige Strategien, deren Umsetzung hier sichtbar ist und nicht in den Modulen detaillierter besprochen werden: \\
...
Dieses Diagramm beschreibt die in unserem System verwendeten Services. Unser System soll z.B. bei der Erstellung von Benutzern E-mails versenden können, wozu wir das Email Modul haben. Zugleich soll unser System durch Apache Shiro gesichert sein, wodurch wir das Modul Apache Schiro haben. Wir möchten zur Datenverwaltung außerdem noch Deltaspike Data benutzen wodurch wir auch dieses Modul haben.  
...
\end{center}
\end{figure}
Dieses Modul ist für die Erstellung und Verwaltung von Nutzern zuständig. Durch UserController können z.B. neue Nutzer erstellt werden, oder die Daten von bestehenden Users verändert werden. Dafür greift Controller auf die Datenklasse User zu, um diese Nutzer zu erstellen und verwalten. Um diese anschließend in der Datenbank abspeichern zu können, greift UserController auf die UserDAO zu, um die Benutzer in der Datenbank zu speichern und verwalten. In der Datenklasse von User wird zudem auch die eingestellte Sprache des Nutzern eingespeichert und nach Wunsch geändert.\\
Die Beans für jeden einzelnen Nutzer werden für ein Umsetzen der Rollen mit Apache Shiro nach Strategie 2.1 gebraucht. 
Die Umsetzung von Strategie 1.2 zeigt sich im UserController in den Methoden get/set/removeRole. 
...
Der AuftragsLog beschreibt die Umsetzung der Strategie 5.1.
\newpage
...
Hier wird Strategie 3.1 für die Prozessschritte umgesetzt.
\newpage
...
\end{center}
\end{figure}
Nun möchte man ja vielleicht Prozessschritte erstellen. Ein Prozessschritt benötigt einen Prozessschrittszustandsautomat und einen Prozessschrittlog. Um nun Prozessschritte erstellen zu können muss unser Prozessschrittcontroller Zugriff auf die Prozessschritt Datenklasse haben, und um diese anschließend in der Datenbank verwalten zu können braucht er auch Zugriff auf ProzessschrittDAO.\\
...
Nun kommen wir zum Modul Probe. Die Proben in unserem System müssen erstellt und verwaltet werden können, wodurch der Probencontroller Zugriff auf die Proben Datenklasse haben muss. Außerdem muss man die Proben in der Datenbank auch verwalten können, wodurch der Probencontroller Zugriff auf ProbeDAO haben muss.\\
...
Durch set- und getArchiv in der Klasse ProbeController kann für eine Probe das Archiv gesetzt und zurückgegeben werden. Durch das Setzen des Archivs wird eine Probe archiviert. Es gibt außerdem die Klasse Archiv, die alle notwendigen Informationen speichert. Das ist unsere Umsetzung der Strategie 16.1.
Mithilfe von addComment im ProbeController kann ein Pair aus Kommentar und Zeit einer Probe zugeordnet werden. Dadurch wird Strategie 20.3 umgesetzt. 
...
Durch die Klasse TraegerArt wird Strategie 17.3 umgesetzt. \\
