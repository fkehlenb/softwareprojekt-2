...
\begin{table}[H]
    ...
    \hline
         ...
         \hline
          \textbf{Strategien} \\ \hline
          \textbf{Strategie 2.1: JavaEE Security(ausgewählt)} Das system wird das Java Class PasswordAuthentication nutzen, durch wen die User sich anmelden können. \\ % das was liam meinte (steht in altem commit?
...
\begin{table}[H]
    ...
    \hline
          ...
          Der Prozesskettenadministrator möchte abstrakte Prozessketten und -schritte erstellen können, die als Vorlagen dienen. Die Prozesskettenvorlagen sollen aus Prozessschrittevorlagen bestehen, und instanziiert werden können. \\
          \\ \hline
          \textbf{Einflussfaktoren: } \\
          Faktoren \\ %hier fehlt noch was
...
\end{table}
Hier haben wir uns für die erste Strategie entschieden, weil .. \\
...
\begin{table}[H]
    ...
    \hline
          ...
          \\ \hline
          \textbf{Einflussfaktoren: } \\
         Fak \\ %hier fehlt noch was -> evtl neue Faktoren?
          \hline
          \textbf{Strategien} \\ \hline
...
\end{table}
Hier haben wir uns für die zweite Strategie entschieden, weil für die Kommentare keine großen Details gespeichert werden müssen. (Vor allem im Bezug auf die User könnte es hierbei sonst zu Problemen mit der DSVGO kommen) \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{%Korrekturvorschlag Samuel
\textbf{BusinessLogik:} Die Businesslogik beinhaltet die Funktionalität des Systems. Sie nutzt die Schnittstellen Data von Persistence und nutzt die Update Schnittstelle von Model. Sie ergibt sich aus Strategie 15.1
}
...
{%Korrekturvorschlag Samuel
\textbf{Model:} Hier liegen die Daten der User, Prozessketten, Proben sowie Daten und Vormerkungen des System. Model stellt ein Interface Update zur Verfügung, welches von Businesslogic und Persistence genutzt wird. Diese Komponente ergibt sich aus der Strategie 15.1.\\
}
...
{%Korrekturvorschlag Samuel
\textbf{Interface:} Hier liegt unser User Interface, also die xhtml Website, in der die User mit dem System interagieren. Interface nutzt das Interface liferung von Controller
...
=======
\textbf{Interface:} In diesem Teil liegt die User Interface, wo die User mit den System interagieren können. Diese Problem Karte beziehen sich aus Strategie 1.2, weil jede User hat ein unterschiedliche Oberfläche, mit wenn er mit des System interagieren kann. Außerdem ergibt sich aus die Strategie 15.1: Kapselung des Datenhaltung ~\ref{sec:strategie15.1}.
Diese Komponente ist verwunden mit der BusinessLogik, um die Request und Data Bearbeitung zu erreichen.\\
\textbf{Model:} Hier liegen die Daten der User, Prozesskette , Proben sowie Daten und Vormerkungen des System. Diese Komponente ist mit der Interface verwundet, weil die Daten das Interfaces gezeigt werden, sind das an der Model implementieren. Diese Komponente ergibt sich aus der  Strategie 15.1: Kapselung des Datenhaltung ~\ref{sec:strategie15.1} \\
\textbf{Persistenz:} Hier liegt die Verbindungen zwischen das System und Datei an der Dateibase, Diese Komponente ist verantwortlich und die Speicherung und Schreibung Funktionen an der Dateibase. diese Komponente  ist getroffen an der Anwendung der verlangte Technologie.  \\
\textbf{BusinessLogik:} In diese Teil liegt die Funktionalität des System, diese Teil ist verantwortlich die Interaktion zwischen die Modelle und die Bearbeitung ihre Data in die Persistenz Komponente. Hier sind die das gewuchtetes Verhalten des System implementiert. diese Schnittstelle ergibt sich aus der   Strategie 15.1: Kapselung des Datenhaltung ~\ref{sec:strategie15.1} \\
>>>>>>> Last anderüngen
...
realisieren wir die Strategie 1.2. Wir können somit mehrere Rollen für einen
...
für bestimmte Rollen zulassen. Damit setzen wir die Strategie 2.1 um. Apache
...
Probe Archiviert wurde. Dies wird in der Strategie 16.1 umgesetzt
...
einer Bedingung entsprechen. Hier haben wir die Strategie 10.2 umgesetzt.
...
Strategie 19.2 setzen wir um, indem wir die Zustände einer ProzessSchrittVorlage
...
Hiermit setzen wir die Strategie 7.2 um.

Es gibt drei Arten von ProzessschrittArten: umformend, färbend und ermittelend.
Diese wurden als Enum modeliert, dies ist unsere Umsetzung der Strategie 20.1
...
TODO. Hiermit setzen wir die Strategie 4.1 um. Dafür stellen wir ein Interface
...
Hiermit setzen wir die Strategie 3.1 um. Die Prozessschritte sind somit abstrakt
...
JSON serialisieren (Strategie 4.1), der ProzesschrittLog sowie der Prozesschritt
...
Umsetzung von der Strategie 14.2
...
Zeitstempel werden als Pair gespeichert (Strategie 21.3) und von den
...
speichern wird Strategie 8.1 umgesetzt. Somit kann nachvollzogen werden, zu
...
realisiert. Wir nutzen also lazy loading und setzen damit die Strategie 12.1 um.
...
Umsetzung von der Strategie 13.1
