...
\includegraphics[width=1\textwidth]{Screenshots/311FlaschBenutzer.png}
\textit{Abbildung 3.1.1.6: Falscher Benutzername Eingegeben}
} \\

Man kann einen \hyperlink{sc3.1.1.6}{flaschen Benutzernamen} eingeben, und dann wird dabei die Meldung \hyperlink{sc3.1.1.7}{\textit{Unknown User}} ausgegeben. \\

\hypertarget{sc3.1.1.7}{
\includegraphics[width=1\textwidth]{Screenshots/311BenutzerFalsch.png}
\textit{Abbildung 3.1.1.7: Fehlermeldung: Falscher Benutzername Eingegeben}
} \\
