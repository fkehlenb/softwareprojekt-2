...
Um eine Annäherung an die Variablen und Funktionen jeder Klasse vorzunehmen, wurde das Intellij-Plugin "Testme" verwendet, das die Möglichkeit bietet, eine Ansicht der Methoden in jeder Klasse zu erstellen. Anschließend wurden die Tests vollständig reformiert, um sie verwenden zu können das Projekt. Die Einschränkungen der Junit-Tests wurden durch manuelle Tests und automatisierte Tests in Selen abgedeckt.\\
