...
{ \em In diesem Abschnitt sollen Sequenzdiagramme mit Beschreibung(!) 
  ...
  \variante{Wählt die Anwendungsfälle so, dass nach Möglichkeit alle 
  Module Eures entworfenen Systems in mindestens einem Sequenzdiagramm 
...
{ \em Beschreibt in diesem Abschnitt, welche Änderungen Ihr vornehmen
  ...
  unter \gq{Ausblick} genannten Punkte behandelt werden.
}
